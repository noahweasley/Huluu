...
class ForgotPassword extends StatelessWidget {
  ...
  const ForgotPassword({Key? key, required this.resetBtnClick, required this.resetFocusNode, this.email}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        ...
                        style: const TextStyle(color: ColorRes.black2, fontSize: 18, fontFamily: FontRes.semiBold),
              ...
              Container(
                ...
                child: Text(
                  S.of(context).email,
                  style: const TextStyle(color: ColorRes.darkGrey3, fontFamily: FontRes.semiBold),
                ),
              ),
              const SizedBox(
                height: 10,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    color: ColorRes.lightGrey3, shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(5)),
                child: TextField(
