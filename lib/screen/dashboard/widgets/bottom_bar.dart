        ...
        child: Row(
          ...
          children: PrefService.settingData?.appdata?.isDating == 0
              ? [
                  ...
                  iconBox(AssetRes.joinLives, S.current.joinLive, 17.5, 17.5, 2),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            title,
            style: TextStyle(
                fontSize: 12, color: index == pageIndex ? ColorRes.orange2 : ColorRes.dimGrey6, fontFamily: FontRes.medium),
          ),
