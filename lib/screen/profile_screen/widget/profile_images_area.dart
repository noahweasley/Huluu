                            ...
                            child: PageView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return CachedNetworkImage(
                                  imageUrl: '${ConstRes.aImageBaseUrl}${userData?.images?[index].image}',
                                  cacheKey: '${ConstRes.aImageBaseUrl}${userData?.images?[index].image}',
                                  fit: BoxFit.cover,
                    ...
                    Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              socialIcon(AssetRes.instaLogo, 15, onInstagramTap, isSocialBtnVisible(userData?.instagram)),
                              socialIcon(AssetRes.facebookLogo, 21.0, onFacebookTap, isSocialBtnVisible(userData?.facebook)),
                              socialIcon(AssetRes.youtubeLogo, 20.16, onYoutubeTap, isSocialBtnVisible(userData?.youtube)),
                            ],
                          ),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(left: 10, right: 10, bottom: 0, top: 7),
                          child: ClipRRect(
